...
### 요구 사항 정의
일반적으로 사람들이 AI를 간편하게 쓸 때 보통은 세밀하게 요구 사항을 정의하지 않고 그저 요약해줘(예 : Summarize this doucument)라고 하기 때문에 본 테스트에서는 따로 요구 사항을 세밀하게 정의하지 않고 그저 요약해달라고 했을 때의 결과물을 추출했다.
